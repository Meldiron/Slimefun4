...
public final class Categories {
	...
	public static final Category ELECTRICITY = new Category(new CustomItem(SlimefunItems.NUCLEAR_REACTOR, "&bEnergy and Electricity", "", LORE), 4);
	public static final Category GPS = new Category(new CustomItem(SlimefunItems.GPS_TRANSMITTER, "&bGPS-based Machines", "", LORE), 4);
	...
	public static final Category CARGO = new Category(new CustomItem(SlimefunItems.CARGO_MANAGER, "&cCargo Management", "", LORE), 4);
	...
	public static final Category TALISMANS_2 = new Category(new CustomItem(SlimefunItems.ENDER_TALISMAN, "&7Talismans - &aTier II", "", LORE), 3);
